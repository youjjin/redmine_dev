...
ActiveRecord::Schema.define(version: 2022_03_17_100901) do

  create_table "agile_colors", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "agile_data", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "issue_id"
    t.integer "position"
  ...
  create_table "agile_sprints", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "auth_sources", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "boards", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "changes", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "changeset_parents", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "changeset_id", null: false
  ...
  create_table "changesets", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "changesets_issues", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "changeset_id", null: false
  ...
  create_table "custom_field_enumerations", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "custom_fields", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "type", limit: 30, default: "", null: false
  ...
  create_table "custom_fields_projects", id: false, charset: "utf8", force: :cascade do |t|
  ...
  create_table "custom_fields_roles", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "custom_field_id", null: false
    t.integer "role_id", null: false
    t.index ["custom_field_id", "role_id"], name: "custom_fields_roles_ids", unique: true
  end

  create_table "custom_fields_trackers", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "custom_field_id", default: 0, null: false
  ...
  create_table "custom_values", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_file_revision_accesses", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_file_revisions", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_files", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id", null: false
  ...
  create_table "dmsf_folder_permissions", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "dmsf_folder_id"
  ...
  create_table "dmsf_folders", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id", null: false
    t.integer "dmsf_folder_id"
    t.string "title", null: false
    t.text "description"
  ...
  create_table "dmsf_links", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_locks", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_public_urls", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_workflow_step_actions", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_workflow_step_assignments", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_workflow_steps", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "dmsf_workflows", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name", null: false
    t.integer "project_id"
  ...
  create_table "email_addresses", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "user_id", null: false
  ...
  create_table "enabled_modules", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id"
    t.string "name", null: false
    t.index ["project_id"], name: "enabled_modules_project_id"
  end

  create_table "enumerations", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name", limit: 30, default: "", null: false
    t.integer "position"
    t.boolean "is_default", default: false, null: false
    t.string "type"
  ...
  create_table "evmbaseline_issues", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "evmbaselines", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id"
    t.string "subject"
    t.text "description"
    t.string "state"
  ...
  create_table "evmsettings", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id"
  ...
  create_table "import_items", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "issue_categories", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id", default: 0, null: false
    t.string "name", limit: 60, default: "", null: false
  ...
  create_table "issue_relations", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "issue_statuses", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name", limit: 30, default: "", null: false
  ...
  create_table "journal_details", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "member_roles", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "members", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "user_id", default: 0, null: false
    t.integer "project_id", default: 0, null: false
    t.timestamp "created_on"
  ...
  create_table "project_evmreports", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id"
    t.date "status_date"
    t.text "report_text"
  ...
  create_table "projects", id: :integer, charset: "utf8", force: :cascade do |t|
    ...
    t.text "indicator_left_top"
    t.text "indicator_left_bottom"
    t.text "indicator_right"
    t.index ["lft"], name: "index_projects_on_lft"
    t.index ["rgt"], name: "index_projects_on_rgt"
  end

  create_table "projects_trackers", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "project_id", default: 0, null: false
    t.integer "tracker_id", default: 0, null: false
  ...
  create_table "queries", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id"
    t.string "name", default: "", null: false
    t.text "filters"
    t.integer "user_id", default: 0, null: false
  ...
  create_table "queries_roles", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "query_id", null: false
    t.integer "role_id", null: false
    t.index ["query_id", "role_id"], name: "queries_roles_ids", unique: true
  end

  create_table "repositories", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id", default: 0, null: false
  ...
  create_table "roles_managed_roles", id: false, charset: "utf8", force: :cascade do |t|
    t.integer "role_id", null: false
  ...
  create_table "time_entries", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "project_id", null: false
    t.integer "author_id"
    t.integer "user_id", null: false
    t.integer "issue_id"
  ...
  create_table "tokens", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "user_id", default: 0, null: false
  ...
  create_table "trackers", id: :integer, charset: "utf8", force: :cascade do |t|
    t.string "name", limit: 30, default: "", null: false
    t.string "description"
    t.integer "position"
  ...
  create_table "watchers", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "wiki_content_versions", id: :integer, charset: "utf8", force: :cascade do |t|
  ...
  create_table "wiki_contents", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "page_id", null: false
    t.integer "author_id"
  ...
  create_table "wiki_redirects", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "wiki_id", null: false
    t.string "title"
  ...
  create_table "workflows", id: :integer, charset: "utf8", force: :cascade do |t|
    t.integer "tracker_id", default: 0, null: false
